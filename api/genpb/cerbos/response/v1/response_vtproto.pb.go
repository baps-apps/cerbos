...
func (m *PlanResourcesResponse_Meta) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.FilterDebug) > 0 {
		...
		i = encodeVarint(dAtA, i, uint64(len(m.FilterDebug)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *DisablePolicyResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.DisabledPolicies != 0 {
		i = encodeVarint(dAtA, i, uint64(m.DisabledPolicies))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *EnablePolicyResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.EnabledPolicies != 0 {
		i = encodeVarint(dAtA, i, uint64(m.EnabledPolicies))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *DeleteSchemaResponse) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.DeletedSchemas != 0 {
		i = encodeVarint(dAtA, i, uint64(m.DeletedSchemas))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *DisablePolicyResponse) SizeVT() (n int) {
	...
	_ = l
	if m.DisabledPolicies != 0 {
		n += 1 + sov(uint64(m.DisabledPolicies))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *EnablePolicyResponse) SizeVT() (n int) {
	...
	_ = l
	if m.EnabledPolicies != 0 {
		n += 1 + sov(uint64(m.EnabledPolicies))
	}
	n += len(m.unknownFields)
	return n
}
...
func (m *DeleteSchemaResponse) SizeVT() (n int) {
	...
	_ = l
	if m.DeletedSchemas != 0 {
		n += 1 + sov(uint64(m.DeletedSchemas))
	}
	n += len(m.unknownFields)
	return n
}
